...
df_over_50 = df[df['new_price'] > 50]
average_new_price = df_over_50['new_price'].mean()
...
col1, col2 = st.columns([4, 2])
average_price_by_brand = df_over_50.groupby('brand')['new_price'].mean().sort_values(ascending=False)
